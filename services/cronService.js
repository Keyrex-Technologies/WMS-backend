...
export const archiveAttendanceRecords = async () => {
  try {
    ...
    console.log(`Found ${attendanceRecords.length} attendance records to archive`);
    ...
    console.log(`Successfully archived ${attendanceRecords.length} attendance records`);
...
export const initAttendanceArchiving = () => {
  ...
  console.log("Attendance archiving job scheduled to run every 5 minutes (for testing purposes)");
};